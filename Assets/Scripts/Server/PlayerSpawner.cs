...
public class PlayerSpawner : MonoBehaviour
{
    ...
    public void CreateLocalPlayer(Team team)
    {
        ...
        GameObject newPlayerObject = PhotonNetwork.Instantiate("Characters/SportsCar", new Vector3(25f, 1f, -15f), Quaternion.identity, 0, new object[] { (int)team });
...
//        newPlayer.SetTeam( team );
		...
		GameObject hud = Instantiate(Resources.Load("HUDs/SportscarHUD")) as GameObject;
