...
class BoltDebugStartSettings {
  ...
  public static bool startServer {
    get {
      switch (BoltEditorSettings.instance.debugEditorMode) {
        case BoltAutoStarterEditorMode.Server:
          return true;
      }
  ...
  public static bool startClient {
    get {
      ...
      switch (BoltEditorSettings.instance.debugEditorMode) {
        case BoltAutoStarterEditorMode.OneClientExtra:
        case BoltAutoStarterEditorMode.OneClientFromTotal:
          return true;
      }
