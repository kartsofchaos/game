...
public class MultiplayerConnector : MonoBehaviour
{
    ...
    void OnJoinedRoom()
    {
        ...
        Application.LoadLevel("Medieval_Town");
    }
    ...
    void OnCreatedRoom()
    {
        ...
        properties.Add(Constants.BlueScore, (int)0);
        properties.Add(Constants.RedScore, (int)0);
        ...
        properties.Add(Constants.StartTime, PhotonNetwork.time);
