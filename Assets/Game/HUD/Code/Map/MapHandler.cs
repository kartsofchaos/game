...
public class MapHandler
{
    ...
    {
        return this.bundle.LoadAssetAsync(string.Format(HUDConstants.MAP_SEGMENT_PATTERN, x, z, mapSettings.segmentName), typeof(GameObject));
    }
    ...
    {
        return bundle.LoadAsset(string.Format(HUDConstants.MAP_SEGMENT_PATTERN, x, z, mapSettings.segmentName), typeof(GameObject)) as GameObject;
    }
